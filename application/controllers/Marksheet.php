	...
	public function fetchMarksheetTable($classId = null)
	{
		if($classId) {			
			...
			<div class="pull pull-right">
	  			<button class="btn btn-success" data-toggle="modal" data-target="#addMarksheetModal" onclick="addMarksheet('.$classId.')">Add Marksheet</button>	
		  	</div>
		  		
		  	<br /> <br />

		  	<!-- Table -->
		  	<table class="table table-bordered table-hover" id="manageMarksheetTable">
			    <thead>	
			    	<tr>			    		
